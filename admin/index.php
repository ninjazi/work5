<?php
require_once '../handler/all_list.php';
session_start();
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Здравствуйте, <?php echo $_SESSION['username']; ?> </h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <div class="ecommerce-widget">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <form action="../handler/change_users.php" method="POST">
                                                <br>
                                                Введите ваше новое ФИО<br>
                                                <label>
                                                    <input type="text" name="change_username" size="30">
                                                </label><br>
                                                Введите новый пароль<br>
                                                <label>
                                                    <input type="password" name="change_password" size="30">
                                                </label><br>
                                                <label>
                                                    <input type="text" name="id_user" value="<?php echo $_SESSION['id']?>" hidden>
                                                </label>
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Duplicate email List</h5>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Not one order</h5>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead class="bg-light">
                                            ...
                                            <tbody>
                                            <?php
                                            $not_orders = No_one_orders();
                                            foreach ($not_orders as $item) {
                                                foreach ($item as $items) {
                                                    print_r('<tr>');
                                                    print_r('<td>' . $items . '</td>');
                                                    print_r('</tr>');
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">More than two orders</h5>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead class="bg-light">
